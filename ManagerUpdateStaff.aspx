<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ManagerUpdateStaff.aspx.cs" Inherits="ManagerUpdateStaff" %>
                              ...
                              <div class=" form">
                                  <form class="cmxform form-horizontal tasi-form" runat="server">
                                  	  ...
                                  	  <div class="form-group ">
                                          <label for="cname" class="control-label col-lg-2">Staff ID</label>
                                      ...
                                      <div class="form-group ">
                                          <label for="cname" class="control-label col-lg-2">Staff Name</label>
                                          <div class="col-md-4 col-xs-11">
                                              <asp:TextBox ID="txtName" runat="server" class="form-control col-lg-2" MaxLength="150" />
                                              <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="RequiredFieldValidator" ControlToValidate="txtName" ValidationGroup="UpdateInfo" ForeColor="Red" Display="Dynamic" Text="Can't be blank"></asp:RequiredFieldValidator>
                                          </div>
                                      </div>
                                      <!--<div class="form-group ">
                                          <label for="cname" class="control-label col-lg-2">Type</label>
                                            <div class="col-md-5 col-xs-11">
                                                 <label class="label_radio" for="radio-01">
                                                      <asp:RadioButton GroupName="GRB"  ID="radio01" runat="server"  /> Manager
                                                  </label>
                                                  <label class="label_radio" for="radio-02">
                                                      <asp:RadioButton GroupName="GRB" Checked="true" ID="radio02" runat="server" /> Staff
                                                  </label>
                                            </div>
                                      </div>-->
                                      <div class="form-group ">
                                      ...
                                      <div class="form-group ">
                                          ...
                                          <div class="col-md-4 col-xs-11">
                                              ...
                                              <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="RequiredFieldValidator" ControlToValidate="txtEmail" ValidationGroup="UpdateInfo" Text="Can't be blank" ForeColor="Red" Display="Dynamic"></asp:RequiredFieldValidator>
                                             <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ErrorMessage="RegularExpressionValidator" ControlToValidate="txtEmail" ForeColor="Red" ValidationExpression='^([\w-\.]+)@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.)|(([\w-]+\.)+))([a-zA-Z]{2,4}|[0-9]{1,3})(\]?)$' ValidationGroup="UpdateInfo" Display="Dynamic" Text="Wrong Email format"></asp:RegularExpressionValidator>
                                      ...
                                      <div class="form-group ">
                                          ...
                                          <div class="col-md-4 col-xs-11">
                                              ...
                                              <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ErrorMessage="RegularExpressionValidator" Display="Dynamic" ControlToValidate="txtMobile" ValidationExpression="[0-9]{8,11}" EnableViewState="True" EnableTheming="True" ForeColor="Red" Text="Phone must be 8 to 11 ligit numbers" ValidationGroup="UpdateInfo"></asp:RegularExpressionValidator>
                                      ...
                                      <div class="form-group">
                                          <div class="col-lg-offset-2 col-lg-10">
                                              <asp:Button runat="server" id="btnUpdate" text="Update" class="btn btn-danger"  ValidationGroup="UpdateInfo" OnClick="btnUpdate_Click" />
