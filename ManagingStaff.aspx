<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ManagingStaff.aspx.cs" Inherits="ManagingStaff" %>
          ...
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li class="active"><a  href="ManagingStaff.aspx">Managing Staff</a></li>
                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <form runat="server" class="panel-body">
                          		<a href="ManagerAddAccount.aspx"><button type="button" class="btn btn-danger btn-sm">Add New Staff</button></a>
                                <div class="adv-table">
                                    <table  class="display table table-bordered table-striped" id="example">
                                      ...
                                      <tr>
                                          ...
                                          <td><a class="btn btn-info btn-xs" href="ManagerUpdateStaff.aspx?staffID=<%=dtRow[0].ToString() %>"><i class="fa fa-cloud-upload"></i> Update</a>
                                              <a class="btn btn-danger btn-xs" href="ManagingStaff.aspx?action=Delete?staffID=<%=dtRow[0].ToString() %>" onclick="return confirm('Are you sure to delete this record ?')"><i class="fa fa-ban"></i> Delete</a></td>
                                      </tr><%
                                                  No++;
                                           } %>
                                      </tbody>
