<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StudentMyMeeting.aspx.cs" Inherits="StudentMyMeeting" %>
              ...
              <div class="chat-room">
                  ...
                  <aside class="right-side">
                      ...
                      <div class="invite-row">
                          <h4 class="pull-left">Members List</h4>
                      </div>
                      <ul class="chat-available-user">
                          <li>
                                  <i class="fa fa-circle text-success">Meeting Host : </i>
                                  <%=DaoStaff.GetStaffNameByID(TblMeetings.MeetingHost) + " (" + TblMeetings.MeetingHost + ")" %>
                          </li>
