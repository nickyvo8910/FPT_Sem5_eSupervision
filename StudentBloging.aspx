<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StudentBloging.aspx.cs" Inherits="StudentBloging" %>
      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li>
                      <a href="StudentBloging.aspx" class="active">
                  ...
                  <div class="col-md-12">
                      <section class="panel">
                          <div class="cover-photo">
                              ...
                              <div class="fb-name">
                                  <h2><a href="#"><%=TblCrrStudent.StudentName %></a></h2>
                              </div>
                          </div>
                          <div class="panel-body">
                              <div class="profile-thumb">
                                  <img src="Uploads/Avatars/<%=TblCrrStudent.StudentAvatar %>" alt="">
                              </div>
                              <a href="#" class="fb-user-mail"><%=TblCrrStudent.StudentMailAddr %></a>
                          </div>
                      </section>
                      ...
                      <section class="panel">
                          ...
                          <div class="panel-body">
                              ...
                              <div class="fb-user-details">
                                  <h3><a href="#" class="#"><%=TblCrrStudent.StudentName %></a></h3>
                              ...
                              <div class="pull-right">                                  
                                  <a href="StudentBloging.aspx?action=Delete&&postID=<%=dtRow[0].ToString() %>" class="btn btn-danger" type="submit">Delete</a>
                              </div>
