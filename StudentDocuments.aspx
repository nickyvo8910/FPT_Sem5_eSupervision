<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StudentDocuments.aspx.cs" Inherits="StudentDocuments" %>
      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li>
                      <a href="StudentDocuments.aspx" class="active">
                                    ...
                                    <asp:GridView  class="display table table-bordered table-striped" ID="GridView1" runat="server" AllowSorting="True" GridLines="None" AutoGenerateColumns="False" OnRowCommand="GridView1_RowCommand">
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Functions">
                                                    <ItemTemplate>
                                                        <asp:LinkButton ID="LinkButton1" runat="server" CommandArgument='<%# Eval("documentLink") %>' class="btn btn-primary btn-xs" CommandName="cmdDownload"><i class="fa fa-cloud-download"></i> Download</asp:LinkButton>
                                                        
                                                        <asp:LinkButton ID="LinkButton3" runat="server" CommandArgument='<%# Eval("documentID") %>' class="btn btn-danger btn-xs" CommandName="cmdDelete"><i class="fa fa-ban"></i> Delete</asp:LinkButton>
