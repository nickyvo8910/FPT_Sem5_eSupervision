<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StaffMessagings.aspx.cs" Inherits="StaffMessagings" %>
      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li>
                      <a href="StaffMessagings.aspx" class="active">
              ...
              <form runat="server" class="chat-room" >
                          ...
                          <asp:GridView ID="GridView1" runat="server" BorderStyle="None" style="width:100%" CssClass="table table-hover table-striped" AutoGenerateColumns="False">
                              <Columns>
                                  ...
                                  <asp:TemplateField HeaderText="Function">
                                      <ItemTemplate>
                                          <a class="btn btn-info btn-xs" href='StaffMyMessaging.aspx?studentID=<%#Eval("stuID")%>'>Join/Read</a>
                                      </ItemTemplate>
                                  </asp:TemplateField>
                              </Columns>
                          </asp:GridView>  
                  ...
                  <aside class="right-side">
                      ...
                      <ul class="chat-available-user">
                          ...
                          <li>
                              <a href="StaffMyMessaging.aspx?studentID=<%=dtRow[0].ToString() %>">
                                  <i class="fa fa-circle text-success"></i>
                                  <%=dtRow[0].ToString() + " : "+ dtRow[1].ToString() %>
                              </a>
                          </li>
                          <%} %>
                      </ul>
